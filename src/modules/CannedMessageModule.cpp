...
void CannedMessageModule::LaunchFreetextPrompt(const char *header, const std::string & /*initial*/,
                                               std::function<void(const std::string &)> onSubmit)
{
    ...
    strlcpy(graphics::NotificationRenderer::alertBannerMessage, header ? header : "Enter text",
